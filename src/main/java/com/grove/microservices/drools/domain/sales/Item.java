package com.grove.microservices.drools.domain.sales;
...
public class Item implements Serializable {
    ...
    public Item(String name, BigDecimal cost, BigDecimal salePrice) {
        this(null, name, cost, salePrice);
    }
    
    public Item(Long id, String name, BigDecimal cost, BigDecimal salePrice) {
        this.id = id;
        this.name = name;
        this.cost = cost;
